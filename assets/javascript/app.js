  ...
  $(document).on("click", '.compilation-search-button', function () {
    ...
    $.ajax({
      ...
      if (bookWorks.length === 0) {
        ...
        $("#user-book").html(subjectBookTitle);
    ...
    //Robohash.org
    var url = "https://robohash.org/artSearchTerm.png?set=set4";
    var robotResult = $(`
      <img src="${url}" class="img-fluid robot-result" alt="Robot Image">
      <h3 class="card-title">Your Kitten</h3>
      <p>Kittens hydroponically generated by <a href="https://robohash.org/" target="_blank">Robohash.org</a></p>
    ...
    $.getJSON(apiEndpointBaseURL + "?" + queryString, function (data) {
      ...
      if (randomHarvardImage === 'undefined' || randomHarvardImage === 0) {
        ...
        $("#user-art").html(randomHarvardImageTitle);
